...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/tests/policeCIV/cms/admin/userprofile.php?uid=<?php echo htmlentities($row['id']);?>');" title="View Details">
