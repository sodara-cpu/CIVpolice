...
$complainno=$cmpn;
echo '<script> alert("votre declaration a été enregistré avec succes et le numero  complaintno est  "+"'.$complainno.'")</script>';
}
?>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Registre plainte</h3>
...
<option value="">Selectionné Category</option>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">type plainte</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Nature de la plainte(témoin/victime)</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label"> Details declaration (max 2000 words) </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" class="form-control" maxlength="2000"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">plainte Related Doc(if any) </label>
<div class="col-sm-6">
