...
<html lang="en">
  <head>
    ...
    <title>CMS | Details plainte </title>
...
<?php include('includes/sidebar.php');?>
      <section id="main-content" style="padding-left:5%; color:#000">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Details plainte</h3>
            <hr />
...
{?>
          	<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Numero plainte : </b></label>
          		<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><b>Sub Category :</b> </label>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>type de plainte :</b></label>
              <div class="col-sm-4">
...
<?php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>details plaintes </label>
              <div class="col-sm-10">
...
<label class="col-sm-2 col-sm-2 control-label"><b>status final :</b></label>
              <div class="col-sm-4">
