...
error:function (){}
  ...
  <body>
	  <div id="login-page">
	  	<div class="container">
	<h3 align="center" style="color:#fff"><a href="../index.html" style="color:#fff">Enregistrement utilisateur</a></h3>
	<hr />
		      <form class="form-login" method="post">
		        <h2 class="form-login-heading">Enregistrement user</h2>
