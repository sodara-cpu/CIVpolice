...
<html lang="en">
  <head>
    ...
    <title>CMS | Historique des plaintes</title>
...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Votre Historique des plaintes</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr style="text-align: center">
                                  <th style="text-align: center">Numero plainte</th>
                                  <th style="text-align: center">date</th>
                                  <th style="text-align: center">derniere mis a jour</th>
