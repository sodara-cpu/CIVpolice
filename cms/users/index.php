...
return true;
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
	  		<h3 align="center" style="color:#fff"><a href="../index.html" style="color:#fff">GESTION DES PLAINTES</a></h3>
	<hr />
		      <form class="form-login" name="login" method="post">
		        <h2 class="form-login-heading">CONNECTE VOUS MAINTENANT</h2>
		        ...
		        <div class="login-wrap">
		            ...
		            <label class="checkbox">
		                <span class="pull-right">
		                    <a data-toggle="modal" href="login.html#myModal"> MOT DE PASS OUBLIÉ?</a>
		
		                </span>
		            </label>
		            <button class="btn btn-theme btn-block" name="submit" type="submit"><i class="fa fa-lock"></i> SE CONNECTÉ</button>
		            <hr>
		           </form>
...
<input type="password" class="form-control unicase-form-control text-input" placeholder="Confirm Password" id="confirmpassword" name="confirmpassword" required >
		                      ...
		                      <div class="modal-footer">
		                          ...
		                          <button class="btn btn-theme" type="submit" name="change" onclick="return valid();">Envoyer</button>
		                      </div>
		                  </div>
		              </div>
		          </div>
