...
{?>
					  			...
					  			<p><?php echo htmlentities($num1);?> plainte pas encore traité</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> statut des plaintes en cours</p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> plainte traité</p>
                      </div>
